...
expiry_dates = [pd.to_datetime(e, errors="coerce") for e in all_expiries]
...
# VECTORIZED gamma and GEX calculation (MUCH faster than apply)
...
value_col = metric_map.get(METRIC, "net_oi")
